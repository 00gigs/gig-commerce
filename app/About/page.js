  ...
  return (
    <div className="bg-slate-100 w-screen min-h-screen ">
      ...
      <p className="italic underline bg-clip-text text-transparent bg-gradient-to-l from-teal-200 via-slate-200 to-amber-200  font-bold tracking-widest">Hanz</p> -
          ...
          <h2 className=" flex text-[22px] font-bold italic tracking-wide"> "Bringing Homes and Hearts Together"</h2>
        </div>{/**headBanner  */}
        ...
        <p className='m-4 font-extrabold text-[22px]  underline'>Where the Journey Began</p>
          ...
          <h2 className="font-extrabold underline text-[22px] mt-2 ">Our Mission</h2>
        
          <p className="font-light text-[24px] leading-10  text-[18px] tracking-tight my-3 noto-znamenny">At Hanz, we believe in the power of home. It's not just a place but it's where the heart finds peace, comfort, and belonging. Our mission is twofold: to provide top-tier, all-in-one solutions for every home need, from landscaping and Handy-Man needs to cleaning and moving, and to use our business as a platform for bringing the community together.</p>
          <h2 className="font-extrabold underline text-[24px]  leading-10 mt-2 ">A Family at Your Service</h2>
          ...
          <h2 className="font-extrabold underline text-[24px]  leading-10 mt-2 ">Community at the Core</h2>
          ...
          <h2 className="font-extrabold underline text-[24px]  leading-10 mt-2 ">Looking Ahead</h2>
