...
<div className="bouncing-div flex justify-center items-center my-4 sm:my-6 lg:my-8">
    ...
    >
        ...
        <div className="m-3">{/**text content  */}
          ...
          <h2 className="font-bold text-[22px] mt-2 hover:scale-110 text-yellow-300"> <a href="https://www.hanzhomesolutions.com/landscaping">Transform Your Outdoors with Hanz Landscaping</a></h2>
          ...
          <h2 className="font-bold text-[22px] mt-2 hover:scale-110 text-yellow-300"><a href="https://www.hanzhomesolutions.com/GeneralContract">Build Your Vision with Hanz Handy-Man Experts</a></h2>
          ...
          <h2 className="font-bold text-[22px] mt-2 hover:scale-110 text-yellow-300"><a href="https://www.hanzhomesolutions.com/Cleaning">Keep Your Home Spotless with Hanz Cleaning Services</a></h2>
          ...
          <h2 className="font-bold text-[22px] mt-2 hover:scale-110 text-yellow-300"><a href="https://www.hanzhomesolutions.com/Moving">Move with Confidence with Hanz Moving Services</a></h2>
