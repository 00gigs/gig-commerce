  ...
  return (
    <div className='h-100 bg-slate-200'>
        ...
        <div className='text-black'>
          <Link href='/Booking' className="p-3 border-black flex justify-center bg-green-200 font-bold w-full  mt-2 duration-200 hover:bg-green-400 hover:text-green-100 hover:font-extrabold" > Book Moving services today </Link>
...
<div>
<Link href='/Booking' className=" p-3 flex justify-center bg-green-200 font-bold w-full  mt-2 duration-200 hover:bg-green-400 hover:text-green-100 hover:font-extrabold" > Book Moving services today </Link>
</div>
