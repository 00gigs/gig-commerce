...
<img className='float-right w-48 h-40 object-cover mx-3 my-2 border-2 border-black rounded' src='https://images.pexels.com/photos/4246266/pexels-photo-4246266.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'/>
  <h1 className='font-bold text-sm mb-4'>"HANZ DELIVERS RELIABLE MOVING SERVICES WITH A FOCUS ON EFFICIENCY AND PRECISION."</h1>
  <p className='font-light text-[26px]'>Make your move hassle-free with Hanz, your dependable choice for residential and commercial moving services. From loading and unloading to careful packing and unpacking, our experienced team handles every detail of your move with precision and care. Trust Hanz to manage your relocation smoothly and securely.</p>
  </div>
</div>   
<div>
...
<h1 className='font-bold text-sm mb-4'>"OUR SKILLED MOVERS PROVIDE AFFORDABLE, QUALITY SERVICES FOR YOUR MOVE."</h1>
<p className='font-light text-[26px]'>At Hanz, we help make your move seamless and stress-free. Our team of skilled movers expertly manages each step of the process, ensuring your belongings are safely transported and properly settled in your new space. Our comprehensive moving services include:</p>
 ...
 <p className='font-medium text-lg'>"Let Hanz provide you with cost-effective, reliable moving solutions that meet your needs and exceed your expectations. Enjoy a smooth and stress-free moving experience with our team."</p>
