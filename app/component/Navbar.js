...
const Navbar = () => {
  ...
  return (
    <div className="bg-amber-400 w-full h-14 flex justify-between items-center p-3 border-b-2 shadow-xl border-orange-100">
      {/**main*/}
          ...
          >
            <div>
              ...
              <ul className="mx-3">
                ...
                <li className="hover:cursor-pointer my-2 noto-sans-mono">
                  <a href='tel:+2406967197'>- Talk to a team member</a>{" "}
                </li>
                <li className="hover:cursor-pointer my-2 noto-sans-mono">
