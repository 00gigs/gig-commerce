...
const handleSubmit = async (e)=>{
  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#D1CAC2] bg-[url('/Black And White Aesthetic Minimalist Modern Simple Typography Coconut Cosmetics Logo.png')] bg-cover bg-center">
